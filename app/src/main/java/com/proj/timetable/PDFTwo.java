...
public class PDFTwo extends Activity {
        ...
        switch (requestCode) {
            case REQUEST_EXTERNAL_STORAGE: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(PDFTwo.this, "Error", Toast.LENGTH_SHORT).show();
                }
                return;
            }
    ...
    public  void createPDF(){
        ...
        try {
            ...
            Intent pdfv = new Intent(PDFTwo.this, PDFLoader.class);
            startActivity(pdfv);
            ...
            e.printStackTrace();
            Toast.makeText(PDFTwo.this, "File Not Found:"+e, Toast.LENGTH_LONG).show();
        } catch (DocumentException e) {
            // TODO Auto-generated catch block
            Toast.makeText(PDFTwo.this, "No Support in your device:"+e, Toast.LENGTH_LONG).show();
            e.printStackTrace();
